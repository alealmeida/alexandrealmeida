...
const HighlightsJobs = ({
  ...
  const getBackground = (background, brand) => [background || (brand === low_brand ? `theme-${low_brand}-primary` : null)];

  const Highlights = styled_components_cjs/* default.header */.ZP.header`
	background: var(--color-${({
    brand,
    color
  }) => getBackground(color, brand)});
	${({
    brand
  }) => styleTheme[brand]};
	`;
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      processEnv([{"path":".env.production","contents":"GQL_URL =  'http://localhost:1337/graphql'"}])
      ...
      const compMod = __webpack_require__(2041)
      ...
      const { renderReqToHTML, render } = (0,next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__/* .getPageHandler */ .u)({
        ...
        i18n: undefined,
        page: "/",
        buildId: "N-7FyMLFKUORHGIfVRpKV",
        escapedBuildId: "N\-7FyMLFKUORHGIfVRpKV",
        basePath: "",
        pageIsDynamic: false,
        encodedPreviewProps: {previewModeId:"988122a7862f68b6965e27e2b9c10fd5",previewModeSigningKey:"86bb8312736c701fb670a8ba93aa72368013dc7b32fa07f4079688d549878f8d",previewModeEncryptionKey:"1f41e8f6ec10a5c285048d202fb9d1926ef16ccb9143535ed6fe5bdc21fc71e5"}
      })
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [721,901,727,289], function() { return __webpack_require__(89107); })
